    ...
    <footer className={location.pathname === '/' ? 'footer footer_landing' : 'footer'}>
      ...
      <div className='footer__container'>
        ...
        <div className='footer__container-link'>
          ...
          <a className='footer__link' target="_blank" href='https://github.com/OlegKolovanov'
          >Github</a>
          <a className='footer__link' target="_blank" href='https://tlgg.ru/@OlegKolovanov'>Telegram</a>
        </div>
      </div>
    </footer>
